...
const Sidebar = () => {
  const { user } = useUser();
  const [, setGroupedData] = React.useState<{ owner: RoomDocument[]; editor: RoomDocument[] }>({ owner: [], editor: [] });
    ...
    <div ref={containerRef} className="bubbles fixed inset-0 z-10">
      <div className="relative z-50 flex items-center -mt-10 justify-center min-h-[97vh] px-4 pb-20">
        <div className="max-w-2xl mx-auto p-8 bg-white/80 backdrop-blur-lg border border-gray-300 rounded-2xl shadow-2xl text-center space-y-4">
          <h1 className="text-4xl font-bold text-gray-900">Welcome to IntelliPage</h1>
          <p className="text-gray-600 text-lg leading-relaxed">
            Create, collaborate, and enhance your documents effortlessly. IntelliPage gives you the flexibility of Notion—plus more.
          </p>

          {/* Feature List */}
          <div className="space-y-4 text-gray-700">
            {[
              { icon: Rocket, color: "text-blue-500", title: "Live Collaboration", desc: "Work with your team in real-time." },
              { icon: BrainCircuit, color: "text-purple-500", title: "AI Assistance", desc: "Get smart summaries on the go." },
              { icon: Files, color: "text-green-500", title: "Seamless Organization", desc: "Keep your work structured with an intuitive document system." },
          ...
          {user ? (
            <>
              ...
              <div className="flex flex-col items-center space-y-3">
                <p className="text-gray-700 text-m">Get started by creating a new document.</p>
                <NewDocument />
              </div>

              {/* Secondary Action Button */}
              <div className="flex flex-col items-center space-y-3">
                <p className="text-gray-700 text-sm">Or go to your created docs</p>
                <Link href="/doc">
            ...
            <div className="text-center space-y-3">
              <p className="text-gray-700 text-m font-semibold">Login to create new documents or edit existing ones.</p>
              <div className="px-4 py-2 text-white bg-orange-500 font-medium rounded-lg shadow-md 
        ...
        <div className="custom-shape-divider-bottom-1741448917 relative z-10">
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            ...
            <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="url(#gradient-fill)"></path>
          </svg>
        </div>
      </div>
        <div className='className=" text-white p-6 flex justify-center  bg-gradient-to-r from-red-600 to-orange-400 font-medium rounded-lg shadow-md 
