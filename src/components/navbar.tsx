...
const Navbar = () => {
  ...
  return (
    <div className="relative font-serif flex items-center justify-between px-6 md:px-10 py-4 
      ...
      <div className="flex items-center space-x-4">
        <SignedOut>
          ...
          <div className="px-4 py-2 bg-white text-orange-500 font-medium rounded-lg shadow-md 
        ...
        <SignedIn>
          <div className="flex items-center space-x-2">
            <p className="hidden md:block text-sm font-medium">{user?.fullName}</p>
